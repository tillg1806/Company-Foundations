...
```text
daily HQ tax = max(0, HQ base tax + employee tax - station tax relief)
```
...
| --- | ---: |
| Base value | 300 |
| Republic, Syndicate, Free Worlds, Deep Security | sets base to 350 |
| Hai, Coalition, Heliarch | sets base to 450 |
| rim, frontier, dirt belt, south pirate, north pirate, core pirate, pirate | -150 |
| Pirate, Independent, Neutral | maximum 250 before further attributes |
| south | -100 |
...
## Employee Tax Scaling

Employee tax is calculated from `total staff`. Divisions in the formula use integer thresholds.

| Component | Calculation |
| --- | ---: |
| Base share | total staff * 5 |
| per 5 staff | +20 |
| per 10 staff | +40 |
| per 20 staff | +100 |
| per 50 staff | +250 |
| per 100 staff | +600 |
| per 500 staff | +4,000 |
| per 1,000 staff | +10,000 |

## Staff Calculation

| Component | Calculation |
| --- | --- |
| Worker staff | Ship crew from active routes, claims, security contracts, and admiral fleet / 100 |
| Office staff | max(worker staff - 1, 0) / 2 |
| Specialist staff | active specialist traders + manager + fleet admiral |
