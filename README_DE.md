...
Company Foundations ergaenzt Endless Sky um eine spielbare Firmenverwaltung fuer
normale Piloten. Du kannst an zugaenglichen bewohnten Raumhaefen eine Firma
registrieren und Shuttle-, Mining-, Trading- und Security-Sparten von einem
Hauptquartier-Planeten aus betreiben.

Der aktuelle Stand ist ein MVP-Balance-Pass fuer frische Playthroughs, mit
...
Firmenregistrare sind an geeigneten besuchten Raumhaefen verfuegbar, wenn deine
Reputation dort zum Landen reicht. Die aktuellen Daten unterstuetzen 366
zugaengliche und besuchbare Hauptquartiere.
...
Jede neue Firma startet eigentuergefuehrt, mit aktiviertem AutoPay, 25% Owner
Payout Share, HQ-Steuerregistrierung und einem lokalen Start-Asset. Nach der
Gruendung koennen weitere Sparten ueber das Firmenpanel hinzugefuegt werden, wenn
Kapital und Anforderungen passen.

## Erkundung Und Beschaffung

Firmenwachstum haengt an Erkundung. Wenn du auf einem Raumhafen landest, merkt
...
das relevante System oder der relevante Planet bekannt ist. Schiffskaeufe
erscheinen erst, nachdem du einen Shipyard besucht hast, der dieses Schiff
verkauft. Startschiffe werden zusaetzlich als bekannte Beschaffungskanaele
...
- Erwarteten Tagesumsatz, Ausgaben, Nettogewinn, Owner Payout und Retained
  Earnings.
- Spartenuebersichten fuer Shuttle, Mining, Trading und Security.
...
- Lifetime Gross, Expenses, Taxes, Manager Costs, Owner Allocations und Retained
  Earnings.
- HQ-Umzuege, Access Suspensions und Operating-Loss-Files.

Das Panel ist in praktische Menues fuer Payout Policy, Lizenzen, Schiffe,
Manager, detaillierte Bilanz, HQ-Verwaltung, Stationsbau und Investment geteilt.

## Payouts Und AutoPay

Positiver Nettogewinn wird nach dem Owner Payout Share aufgeteilt. Moegliche
...
Kompatibilitaetsbedingungen sichtbar.

Verlustperioden erzeugen keinen Owner Payout. Stattdessen oeffnen sie einen
...
Shuttle. Die Routendauer haengt von der Anzahl zugewiesener Schiffe ab, die
Auszahlung von Routenlaenge und Passenger Bunks.
...
schalten pro Route einen VIP-Servicevertrag fuer einen Bonus frei. Jede Route hat
ein Passenger Cap, daher lohnt sich Expansion ueber mehr Routen und passende
Schiffe statt eine einzelne Route endlos zu stapeln.

Manager koennen ausserdem Routenlizenzen kaufen und Shuttle-Routen in
vordefinierte Pakete optimieren, sobald die benoetigten Schiffe entdeckt sind und
...
Mining-Flotten nutzen entdeckte Utility-Schiffe mit passender Cargo-Kapazitaet
...
die verfuegbare Drone-Bay-Kapazitaet der Mining-Schiffe begrenzt.
...
Liners mit genug Cargo-Kapazitaet. Pro Route kann ein Specialist Trader fuer
10,000 Credits pro Tag eingesetzt werden. Er schaltet die Route von einer
konservativen Basismarge auf den staerksten bekannten statischen Commodity Spread
um.
...
unbewohnte Systeme dazwischen brauchen keine eigene Buerokratie.
...
auf echten Schiff-Crew-Werten, und Routenkapazitaet basiert auf Escort Rating.

## Fleet Admiral

Security-Firmen koennen einen Fleet Admiral fuer 300,000 Company Credits plus
20,000 Credits pro Tag einstellen. Der Admiral kommandiert eine unabhaengige
Strike Fleet; Escort-Schiffe zaehlen nicht zum Admiral Fleet Rating.

Der Admiral hat sein Buero im HQ, aber die Strike Fleet hat einen eigenen
physischen Einsatzort. Sie startet im HQ-System und kann fuer 200,000 Company
Credits zu einem anderen zugaenglichen Spaceport verlegt werden. Transit dauert
fuenf Betriebstage.

Waehrend die Strike Fleet unterwegs ist, sind Admiral-Flottenkaeufe und
Pirate-Tribute-Kampagnen nicht verfuegbar. Tribute-Kampagnen verlangen, dass die
Strike Fleet physisch am Zielplaneten stationiert ist.

## Hauptquartier Und Steuern

Lokale HQ-Steuern haengen von Jurisdiction und Planetenattributen ab. Core,
Urban, Capital, Paradise, Rich, Factory, Military und Tourism Worlds kosten eher
mehr. Frontier, Rim, South, Dirt Belt und Pirate Regions sind eher guenstiger.

Wenn die Firma waechst, zaehlt Schiff-Crew als Worker. Groessere Belegschaften
erzeugen simulierten Office Staff, grob ein Office Worker pro zwei Company Worker
nach dem ersten Worker. Employee Taxes skalieren progressiv mit groesseren
Staff-Werten.

Wenn deine Reputation unter die Landing Requirement des HQ-Planeten faellt,
werden Operations pausiert, bis der Zugang wiederhergestellt ist oder du das HQ
von einem anderen zugaenglichen Registrar verlegst. Relocation kostet 500,000
Company Credits und behaelt den bestehenden Managementmodus.

## Orbitale Infrastruktur

Firmen koennen simulierte orbitale Infrastruktur aus der Company Reserve bauen:
...
Station Operations zaehlen in Daily Accounting, Monthly Reports, Projections und
...
Company Reserve, wenn mindestens das Doppelte der Kaufkosten verfuegbar ist.

Manager koennen Routen, Mining Rights, Lizenzen, Schiffe, Mining Drones,
Shuttle-Optimization-Packages, Specialist Traders, Fleet Admirals,
Admiral-Schiffe und Pirate-Tribute-Kampagnen kaufen, wenn die benoetigten
Supplier und Ziele bekannt sind.

Wenn die Firma das Manager-Gehalt von 10,000 Credits an zwei geprueften
Betriebstagen in Folge nicht decken kann, kuendigt der Manager und die Firma
kehrt zu owner-managed operations zurueck. Der Manager kann auch manuell im
Firmenpanel entlassen werden.

## Firmenverkauf

Das HQ-Menue kann die gesamte Firma bewerten und verkaufen. Die Bewertung umfasst
...
Verkauf schliesst Company Charter, Operating Licenses, Stations, Management
